...
Route::group(["prefix" => "admin", "as" => "backend", "namespace" => "Backend"/*,"middleware"=>"admin"*/], function () {
    ...
    Route::group(["middleware" => "admin"], function () {
        ...
        Route::group(["prefix" => "yazar", "as" => ".writer", "namespace" => "Writer"], function () {
            Route::get("/", "WriterController@index")->name(".index");
            Route::post("/status", "WriterController@status")->name(".status");
            Route::post("/delete", "WriterController@destroy")->name(".delete");
